...
public class Main3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        NavigationView navigationView = (NavigationView)findViewById(R.id.drawer_nav1);
        navigationView.setItemIconTintList(null);

        NavController navController = Navigation.findNavController(this,R.id.navHostFargment1);
        NavigationUI.setupWithNavController(navigationView,navController);

        //change Email and username in header
        navigationView = (NavigationView) findViewById(R.id.drawer_nav1);
